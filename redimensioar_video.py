...
sufijo = "_01"
video_entrada = r"D:\Documentos\Ayudante de Investigacion\VIDEOS\CAMARA PRUEBAS"
directorio_salida = r"D:\Documentos\Ayudante de Investigacion\VIDEOS\CAMARA_USB_REDIMENSION"
...
def procesar_video_ia(ruta_entrada):
    ...
    # =====================================================================
    # OPTIMIZACIÓN: Salto directo al fotograma seguro (ej: frame 20)
    # =====================================================================
    FRAME_SEGURO = 20  # Puedes cambiarlo a 15 o 30 según veas tus videos
    cap.set(cv2.CAP_PROP_POS_FRAMES, FRAME_SEGURO)
    ...
    if not rostro_encontrado:
        print("⚠️ No se detectó rostro en el frame seguro. Se usará recorte central por defecto.")
